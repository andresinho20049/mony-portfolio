...
export const NavBar = ({ lang, dictionary }: NavBarPropsType) => {
  ...
  return (
    ...
    >
      ...
      >
        {pages.map((p) => (
          <NavBarLink
            ...
            href={p.href}
            label={
              dictionary.pages[p.labelKey as keyof typeof dictionary.pages]
            }
      ...
      <div
        className={`${
          open
            ? 'mt-5 flex justify-center gap-4 border-t-2 border-gray-500 py-4'
            : 'hidden'
